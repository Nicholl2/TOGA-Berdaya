...
import nailaImg from './assets/Naila.png';
import joshuaImg from './assets/Joshua.png';
import rizalImg from './assets/Rizal.png';
import elsaImg from './assets/Elsa.png';
import nandaImg from './assets/Dian.png';
...
// Navbar component is imported from './Navbar'
...
function UsersPage({ token, user, logout }) {
  ...
  return (
    <div className="bg-[#FBFCF8] text-[#111827] min-h-screen flex flex-col justify-between relative overflow-hidden select-none font-sans pb-24 md:pb-0">
      ...
      {/* DASHBOARD CONTENT */}
      <main className="flex-grow w-full max-w-7xl mx-auto px-4 md:px-8 py-10 z-10 relative">
...
function KatalogPage({ token, user, logout }) {
  ...
  return (
    <div className="bg-[#FBFCF8] text-[#111827] min-h-screen flex flex-col justify-between relative overflow-hidden select-none font-sans pb-24 md:pb-0">
      ...
      {/* MAIN SPLIT CONTENT */}
      <main className="flex-grow max-w-7xl mx-auto w-full px-4 md:px-8 py-4 flex flex-col justify-center z-10 relative">
